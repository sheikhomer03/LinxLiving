                  ...
                  >
                    <div className="flex flex-col items-center justify-center space-y-6">
                      ...
                      {!searchTerm && (
                        <Link
                          href="/admin/products/new"
                          className="mt-4 inline-flex items-center gap-3 px-4 py-2 admin-btn-primary rounded-lg text-[10px] uppercase tracking-[0.16em] font-bold hover:opacity-90 transition-all shadow-sm border border-primary/20"
                        >
                  ...
                  >
                    ...
                    <td className="px-10 py-2.5 text-right">
                      ...
                      {openMenuId === product._id && (
                        <div
                          className="fixed mt-2 w-40 bg-white border border-stone-200 shadow-2xl z-100 animate-in fade-in zoom-in duration-300 text-left"
                          style={{ top: menuPos.top, right: menuPos.right }}
                          onClick={(e) => e.stopPropagation()}
                        >
                          <Link
                            href={`/admin/products/${product._id}/edit`}
                            className="w-full text-left px-6 py-4 text-[12px] uppercase tracking-[0.12em] font-bold hover:bg-secondary/20 flex items-center gap-4 transition-colors border-b border-stone-200/80"
                          >

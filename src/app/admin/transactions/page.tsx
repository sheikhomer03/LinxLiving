  ...
  return (
    <div className="admin-page animate-in fade-in duration-300">
      ...
      <header className="admin-page-header">
        ...
        <div className="flex items-center gap-3 lg:gap-4 w-full sm:w-auto flex-wrap">
          ...
          >
            <RefreshCw
              className={cn(
                "w-3.5 h-3.5 lg:w-4 h-4 text-stone-500 group-hover:text-stone-800 transition-colors",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1: Volume */}
        <div className="bg-white p-4 sm:p-5 border border-stone-200/80 shadow-sm group hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            <p className="text-[9px] lg:text-[10px] uppercase tracking-[0.16em] font-bold opacity-90 group-hover:opacity-80 transition-opacity">
              Batch Volume
            </p>
            <CreditCard className="w-4 h-4 text-stone-800/20 group-hover:text-stone-400 transition-colors" />
          </div>
        ...
        <div className="bg-white p-4 sm:p-5 border border-stone-200/80 shadow-sm group hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <Building2 className="w-4 h-4 text-stone-800/20 group-hover:text-stone-400 transition-colors" />
          </div>
          <div className="space-y-1">
            <p className="text-base lg:text-lg font-serif font-bold text-stone-800 truncate">
        ...
        <div className="bg-white p-4 sm:p-5 border border-stone-200/80 shadow-sm group hover:shadow-md transition-shadow border-l-4 border-l-red-500/10">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            <p className="text-[9px] lg:text-[10px] uppercase tracking-[0.16em] font-bold opacity-90 group-hover:opacity-80 transition-opacity">
              Refunded Magnitude
            </p>
            <Receipt className="w-4 h-4 text-stone-800/20 group-hover:text-stone-400 transition-colors" />
          </div>
      ...
      <div className="bg-white shadow-[0_10px_30px_-15px_rgba(0,0,0,0.5)] border border-primary/5 overflow-hidden">
          ...
          <table className="admin-responsive-table w-full text-left border-collapse">
            <thead>
              <tr className="admin-table-head font-semibold text-[11px] uppercase tracking-[0.12em]">
                ...
                <th className="px-10 py-2.5">Customer Ledger</th>
                <th className="px-10 py-2.5 text-right">Value</th>
                <th className="px-10 py-2.5">Timestamp</th>
                <th className="px-10 py-2.5 text-right">Actions</th>
              </tr>
            </thead>
                ...
                <tr>
                  <td colSpan={5} className="px-10 py-24 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <p className="text-[10px] uppercase tracking-[0.16em] font-bold text-primary/60 lg:block hidden">
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center space-y-6">
                      <div className="w-12 h-12 bg-secondary/10 flex items-center justify-center rounded-full border border-stone-200/80 shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)]">
                        <Receipt className="w-10 h-10 opacity-90 text-stone-800" />
                      </div>
        ...
        {/* Pagination */}
        <div className="p-8 border-t border-stone-200/80 bg-neutral-50/50 flex items-center justify-between">
          <p className="text-[9px] uppercase tracking-[0.18em] font-black opacity-90">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex items-center gap-3 px-4 py-2 border border-stone-200 text-[9px] uppercase tracking-[0.16em] font-bold text-stone-800 bg-white hover:bg-neutral-50 disabled:opacity-90 transition-all shadow-sm"
            >
            ...
            <div className="p-8 md:p-12 text-center space-y-5">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-foreground/60 leading-relaxed font-sans">
                  ...
                  <span className="font-bold text-stone-800 mt-2 block break-all text-xs opacity-80">
                    {chargeIdToRefund}
                  </span>
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 pt-4">
                <button
                  ...
                  className="w-full bg-red-600 text-white py-4 text-[11px] uppercase tracking-[0.16em] font-bold hover:bg-red-700 transition-all shadow-sm flex items-center justify-center gap-3"
                >
                  Process Refund
                </button>
                <button

  ...
  return [
    {
      ...
      body: `At ${storeName.toUpperCase()}, your privacy is paramount. We are committed to protecting the integrity of the data you share with us during your architectural material selection and procurement journey.`,
    },
    {
      id: "information-we-collect",
      title: "2. Information We Collect",
      body: "We collect information essential to providing our premium services, including project specifications, delivery addresses, and contact details for consultation purposes.",
    },
    {
      id: "data-usage",
      title: "3. Data Usage",
      body: "Your information is exclusively used to facilitate your orders, manage logistics, and provide personalized design consultation. We do not sell or trade your data to third parties.",
    },
  ];
}
            ...
            <div className="space-y-6 lg:sticky lg:top-52">
              ...
              <div className="bg-white border border-foreground/10 p-6 space-y-3 shadow-sm">
                ...
                <p className="text-sm text-foreground/70 leading-relaxed">
                  Contact our team about how we collect, use or protect your
                  information.
                </p>
                <Link
                  href="/contact"
